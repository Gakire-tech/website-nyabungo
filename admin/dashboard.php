...
<body class="bg-light d-flex">
  ...
  <aside class="sidebar bg-white shadow-sm d-flex flex-column">
    ...
    <nav class="flex-grow-1 p-3">
      ...
      <a href="#" class="d-block px-3 py-2 rounded text-decoration-none mb-1">Menus</a>
      <!-- <a href="#" class="d-block px-3 py-2 rounded text-decoration-none mb-1">Réservations</a> -->
      <a href="#" class="d-block px-3 py-2 rounded text-decoration-none mb-1">Événements</a>
      <a href="#" class="d-block px-3 py-2 rounded text-decoration-none mb-1">Galeries</a>
      <a href="#" class="d-block px-3 py-2 rounded text-decoration-none mb-1">Utilisateurs</a>
      <a href="#" class="d-block px-3 py-2 rounded text-decoration-none mb-1">Contenu du site</a>
    </nav>
